...
def main():
    ...
    # mkdir /home/iscb/wolfson/annab4/.cache/huggingface/transformers
    ...
    with tqdm(total=args.N) as pbar:
        for i in range(num_batches):
            ...
            for text in texts:
                ...
                samples.append(text)
                scores["XL"].append(p1.cpu().item())
                scores["S"].append(p2.cpu().item())
                scores["Lower"].append(p_lower.cpu().item())
